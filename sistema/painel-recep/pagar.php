...
<div class="mt-4" style="margin-right:25px">
	<?php 
	$query = $pdo->query("SELECT * from contas_pagar where empresa = '$id_empresa' order by id desc");
...
if(@$_GET['funcao'] == "editar"){
	...
	$query = $pdo->query("SELECT * from contas_pagar where empresa = '$id_empresa' and id = '$_GET[id]'");
	$res = $query->fetchAll(PDO::FETCH_ASSOC);
	$total_reg = @count($res);
	if($total_reg > 0){ 
		$valor = $res[0]['valor'];
