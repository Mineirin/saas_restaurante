...
if($total_reg == 0){
  $pdo->query("INSERT into config SET empresa = '0', nome_sistema = 'Sistema De Restaurantes', tipo_rel = 'PDF' ");
}else{
			...
			<aside class="sidebar-left" style="overflow: scroll; height:100%; scrollbar-width: thin;">
				<nav class="navbar navbar-inverse">
					<div class="navbar-header">
						...
						<h1><a class="navbar-brand" href="index.php"><span class="fa fa-usd"></span> ViteSystem<span class="dashboard_text"><?php echo $nome_sistema ?></span></a></h1>
					</div>
						...
						<ul class="sidebar-menu">
							...
							<li class="treeview">
								...
								<ul class="treeview-menu">
									...
									<li><a href="index.php?pagina=anuncios"><i class="fa fa-angle-right"></i> Anuncios</a></li>
							...
							<li class="treeview <?php echo $menu_produtos ?>" >
								...
								<ul class="treeview-menu">
									...
									<li class="<?php echo $entradas ?>" hidden><a href="index.php?pagina=entradas"><i class="fa fa-angle-right"></i> Lista de Entradas</a></li>

									<li class="<?php echo $saidas ?>" hidden><a href="index.php?pagina=saidas"><i class="fa fa-angle-right"></i> Lista de Saídas</a></li>

									<li class="<?php echo $estoque ?>" hidden><a href="index.php?pagina=estoque"><i class="fa fa-angle-right"></i> Estoque Baixo</a></li>

									<li class="<?php echo $trocas ?>" hidden><a href="index.php?pagina=trocas"><i class="fa fa-angle-right"></i> Troca de Produtos</a></li>
							...
							<li class="treeview">
								<a href="#">
									<i class="fa fa-floppy-o"></i>
									<span>Gestão Do Aplicativo</span>
									<i class="fa fa-angle-left pull-right"></i>
								</a>
								<ul class="treeview-menu">
									<li><a href="index.php?pagina=listcategoria"><i class="fa fa-angle-right"></i>Categoria</a></li>

									<li><a href="index.php?pagina=listproduto"><i class="fa fa-angle-right"></i>Produtos</a></li>
